export function MapLegend() {
  return (
    <div className="absolute bottom-4 left-4 z-[500] hidden w-64 rounded-lg border border-slate-200 bg-white/95 p-3 text-xs shadow-panel backdrop-blur md:block">
